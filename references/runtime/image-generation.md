...
1. Show the user the install commands the check printed, adding `--venv DIR` where its note names PEP 668. Once the user confirms them, rerun the check with `--install --yes`, which runs them and checks again.
